...
<h1 align="left">PocketAndroid Aion</h1>
...
PocketAndroid Aion wraps all of the tools a developer will need to begin interacting with the Aion network:
...
Now, you will need to add the aion package within PocketAndroid to your module's `build.gradle` file, like this:
