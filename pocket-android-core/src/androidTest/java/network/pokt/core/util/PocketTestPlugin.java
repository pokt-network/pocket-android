...
public class PocketTestPlugin extends Pocket {
    ...
    @NotNull
    @Override
    public Wallet createWallet(@NotNull String network, @NotNull String netID, @Nullable Object data) {
        return new Wallet("0x0", "0x1", network, netID, data);
    }

    @NotNull
    @Override
    public Wallet importWallet(@NotNull String privateKey, @Nullable String address, @NotNull String network, @NotNull String netID, @Nullable Object data) {
